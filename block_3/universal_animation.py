...
while True:
    ...
    rawData = pd.read_csv(f'output/{file}', encoding='windows-1251')
    ...
    def update_plot(i):
        ...
        for j in range(len(axes)):
            ...
            axes[j].plot(coordData[i * data_skip: (i + 1) * data_skip], paramData[i * data_skip: (i + 1) * data_skip], color='b')
